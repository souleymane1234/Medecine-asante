...
const ModalAjoutAntecedentChirurgicaux = ({onPress, onPressRetour}) => {
    ...
    return (
      <SafeAreaView>
          ...
          <Text style={{fontSize: 20, color: COLORS.black, fontWeight: "bold"}}>Antécédents chirurgicaux </Text>
              <Input
              ...
              <View style={{margin: 10}}>
                      ...
                      <View style={{ backgroundColor: '#bce4f5', borderRadius: 10}}>
                          <TextInput
                              style={styles.input}
                              placeholder="Ex. : Date de la chirurgie, nom de l'intervention chirurgicale, effets secondaires, complication suite à mon opération "
                          />
...
export default ModalAjoutAntecedentChirurgicaux;
