...
const ModalAjoutAntecedentPerso = ({onPress, onPressRetour}) => {
    ...
    return (
      <SafeAreaView>
          ...
          <Text style={{fontSize: 20, color: COLORS.black, fontWeight: "bold"}}>Antécédents médicaux personnel</Text>
              <Input
              ...
              <View style={{margin: 10}}>
                      ...
                      <View style={{ backgroundColor: '#bce4f5', borderRadius: 10}}>
                          <TextInput
                              style={styles.input}
                              placeholder="Ex. : Date de début de l’allergie, épisodes allergique, réactions, intolérance ..."
                          />
...
export default ModalAjoutAntecedentPerso;
