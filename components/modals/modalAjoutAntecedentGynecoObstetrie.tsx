...
const ModalAjoutAntecedentGynecoObstetrie = ({onPress, onPressRetour}) => {
          ...
          <Text style={{fontSize: 20, color: COLORS.black, fontWeight: "bold"}}>Antécédents gynécologie obstetrique</Text>
              ...
              <View style={{margin: 10}}>
                      ...
                      <View style={{ backgroundColor: '#bce4f5', borderRadius: 10}}>
                          <TextInput
                              style={styles.input}
                              placeholder="Ex. : Date des premières menstruations, Régularité du cycle menstruel, Accouchements, Avortements, Chirurgies gynécologiques..."
                          />
...
export default ModalAjoutAntecedentGynecoObstetrie;
